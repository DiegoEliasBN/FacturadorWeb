var lista=[];
var idAlmacenP=$("#id_local").val();
$('.tablaRemision').DataTable({
...
$(".tablaRemision tbody").on("click", "button.agregarProducto", function(){
...
=============================================*/
$(".formularioRemision").on("change", "input.nuevaCantidadProductot", function(){
...
function listarProductost(){
	...
	$("#listaDetalle").val(JSON.stringify(listaProductos));
...
var numProducto = 0;
$(".btnAgregarDetalleR").click(function(){
...
IMPRIMIR PDF
=============================================*/
$(".tablas").on("click", ".btnAutorizarGuia", function(){
var id=$(this).attr("idGuia");
	window.open("http://sistema.laternera-ec.com/?ruta=sri&ride="+id, "_self");
	//window.open("extenciones/tcpdf/pdf/pdf.php","_blank");
})
$(".tablas").on("click", ".btnImprimirGuiaPDF", function(){
	var idGuia=$(this).attr("idGuia");
	console.log(idGuia);
	window.open("http://sistema.laternera-ec.com/?ruta=sri&ride="+idGuia, "_blank");
	//window.open("extenciones/tcpdf/pdf/pdf.php","_blank");
})
