                    ...
                    <form role="form" method="post">
                          <div class="form-group row">
                            ...
                            <div class="col-xs-12 col-sm-1">
                                <div class="input-group" >
                                  <button type="button"  class="btn btn-success btn-lg glyphicon glyphicon-search btnGenerarDeudaF"></button>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-1">
                                <div class="input-group" >
                                  <button type="button"  class="btn btn-primary btn-lg glyphicon glyphicon-list-alt btnGenerarFacturaDeudaF"></button>
                                </div>
                            </div>
                            <div class=" col-xs-12 col-sm-1">
                                <div class="input-group" >
