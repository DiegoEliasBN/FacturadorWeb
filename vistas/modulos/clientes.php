          ...
          <div class="box-body">
            ...
            <div class="form-group">
              <div class="input-group">
                ...
                <input type="number" min="0" class="form-control input-lg" name="nuevoDocumentoId" placeholder="Ingresar Cédula o RUC" required>
              </div>
            </div>
             <div class="form-group">
              <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-address-card-o"></i></span> 
                <select class="form-control input-lg" id="nuevo_tipo_documento" name="nuevo_tipo_documento" required>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
              <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-address-card-o"></i></span> 
                <select class="form-control input-lg" id="tipo_documento" name="tipo_documento" required>
