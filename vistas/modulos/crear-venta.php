              ...
              <div class="box-body">
                <div class="">
                  ...
                  <div>
                    ...
                    ======================================-->
                    <div>
                        <input type="hidden" class="form-control" id="nuevaVenta" name="nuevaVenta" value="0001" readonly>
                    </div>
                    <!--=====================================
                    ID DEL LOCAL
                    ======================================-->
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-1 col-xs-1">
                      <div class="input-group">
                        <a class=" btn btn-primary pull-right" href="crear-venta" target="_blank"><i class="glyphicon glyphicon-duplicate"></i></a>
                      </div>
                    </div>
                  </div>
                  <br>
        ...
        <div class="col-lg-4 col-xs-12">
          <div class="box box-warning">
            <div class="box-body">
              ...
              ======================================-->
              <div style="background-color: #3c8dbc; color: #FFFFFF;font-size: 18px" class="form-control text-center ">
              ...
              <div class="container-fluid">
                <!--<div class="row">
                  <div style="background-color: #3c8dbc; color: #FFFFFF;font-size: 17px" class="text-right col-lg-6 col-xs-6">
                ...
                <div class="row">
                  ...
                  <div class="input-group col-lg-6 col-xs-6">
                          <span class="input-group-addon"><i class="ion ion-social-usd"></i></span>
                          <input type="text" style="font-size: 30px; color:#3c8dbc" class="form-control input-sm" id="subtotal12iva" name="subtotal12iva" total="" placeholder="0.00" disabled="true" required>
                  </div>
                </div>
                <div class="row">
                  <div style="background-color: #3c8dbc; color: #FFFFFF;font-size: 17px" class="text-right col-lg-6 col-xs-6">
                  ...
                  <div class="input-group col-lg-6 col-xs-6">
                          <span class="input-group-addon"><i class="ion ion-social-usd"></i></span>
                          <input type="text" style="font-size: 30px; color:#3c8dbc" class="form-control input-sm" id="subtotal0" name="subtotal0" total="" placeholder="0.00" disabled="true" required>
                  </div>
                </div>
               <!-- <div class="row">
                  <div style="background-color: #3c8dbc; color: #FFFFFF;font-size: 17px" class="text-right col-lg-6 col-xs-6">
                ...
                <div class="row">
                  ...
                  <div class="input-group col-lg-6 col-xs-6">
                          ...
                          <span class="input-group-addon"><i class="ion ion-social-usd"></i></span>
                          <input type="text" style="font-size: 30px; color:#3c8dbc" class="form-control input-sm" min="0" id="nuevoImpuestoVentas" name="nuevoImpuestoVenta" placeholder="0.00" disabled="true" required>
                ...
                <div class="row">
                  ...
                  <div class="input-group col-lg-6 col-xs-6">
                          <span class="input-group-addon"><i class="ion ion-social-usd"></i></span>
                          <input type="text" style="font-size: 30px; color:#3c8dbc" class="form-control input-sm" min="0" id="SubTotal" name="SubTotal" placeholder="0.00" disabled="true" required>
                           <input type="hidden" name="nuevoPrecioImpuesto" id="nuevoPrecioImpuesto">
            ...
            <div class="box-footer">
              <button type="button" disabled="true" id="agregarVenta" class="btn btn-danger pull-right glyphicon glyphicon-floppy-save"></button>
            </div>
          </div>
        </div>
      </form>
