...
$respuestaVenta=ControladorCompras::ctrMostrarCompras($itemVenta,$item2, $valorVenta,$valor2);
...
$itemCliente="id";
$valorCliente=$respuestaVenta["id_proveedor"];
	...
	<table style="font-size:10px; padding:5px 10px;">
		<tr>
			<td style="border: 1px solid #666; background-color:white; width:195px">
				PROVEEDOR: $respuestaCliente[razon_social]
			</td>
			<td style="border: 1px solid #666; background-color:white; width:195px">
