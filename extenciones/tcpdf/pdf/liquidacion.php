...
$valorDetalle="id_liquidacion";
$respuestaVenta=ControladorLiquidaciones::ctrMostrarLiquidaciones($itemVenta,$item2, $valorVenta,$valor2);
$productos=ControladorLiquidaciones::ctrMostrarDetalleLiquidacion($valorDetalle, $valorVenta);
...
//</tr>
$bloque1=<<<EOF
<div style="width:200px; text-align:center"><img src="images/cabecera.png"></div>
...
<table>
	<tr>
			<td style="width:180px; text-align:left">
				<br>
				CI. RUC.: $respuestaCliente[documento]
				<br>
...
$valorProducto = trim($item["descripcion_producto"]) ;
...
$valorUnitario = number_format($item["precio_compra"], 2);
...
********************************************
	...
	<tr> 
		<td style="width:180px;text-align:center; font-size:08px">
			<br>
			SU FACTURA ELECTRÓNICA ESTARÁ DISPONIBLE EN NUESTRA WEB: www.laternera-ec.com <br> INGRESANDO SU NÚMERO DE CÉDULA.
		</td>
	</tr>
	<tr> 
		<td style="width:180px;text-align:center; font-size:08px">
