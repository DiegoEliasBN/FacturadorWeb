...
class ControladorCompras{
	...
	MOSTRAR VENTAS
	=============================================*/
	static public function ctrMostrarCompras($item,$item1, $valor,$valor1){
		$tabla = "compras";
		$respuesta = ModeloCompras::mdlMostrarCompras($tabla,$item,$item1, $valor,$valor1);
		return $respuesta;
	}
	/*=============================================
	CREAR VENTA
	...
	static public function ctrCrearCompra(){
		if(isset($_POST["nuevaVenta"])){
			...
			=============================================*/
			$listaProductos = json_decode($_POST["listaProductosc"], true);
			...
			foreach ($listaProductos as $key => $value) {
			   ...
			   $tablaProductos = "stockalmacen";
			    ...
			    $traerProducto2 = ModeloProductos::mdlMostrarProductoss($tablaProductos,$coda,$almacen);
			...
			$datos = array("id_vendedor"=>$_POST["idVendedor"],
						   ...
						   "impuesto"=>$_POST["nuevoIvac"],
						   "neto"=>$_POST["totalCompra"],
						   "total"=>$_POST["nuevoTotalsitoc"],
	...
	static public function ctrEliminarCompra(){
		if(isset($_GET["idCompra"])){
			...
			$traerVentas = ModeloCompras::mdlMostrarCompras($tabla, $itemVentas,$itemVentas1, $valorVentas,$valorVentas1);
			/*=============================================
			FORMATEAR TABLA DE PRODUCTOS Y LA DE CLIENTES
			=============================================*/
			$productos =  json_decode($traerVenta["productos"], true);
			...
			foreach ($productos as $key => $value) {
				...
				$valor1b = $traerProducto["CantidadIngreso"]-$value["cantidad"];
				$nuevoStock = ModeloProductos::mdlActualizarStock($valor1,$tablaProductos, $item1b, $valor1b, $valor);
			}
			/*=============================================
			ELIMINAR VENTA
