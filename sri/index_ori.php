...
defined('SIGNER_URL_BASE')  or define('SIGNER_URL_BASE', "http://35.168.23.252/rest/");
...
class ComprobantesElectronicos
{
    ...
    private function getGuiaObject($row){
        ...
        foreach ($dt_ret as $item) {
            ...
            $destinatarioRemision['detallesRemision'][] = $impuestoRetencion;
        }
        $fechaEmision = new DateTime($row['fecha']);
        ...
        return array (
            ...
            'destinatarios' => [
                'destinatarioRemision' => $destinatarioRemision
            ]
        );
    }
